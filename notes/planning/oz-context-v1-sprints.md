...
**PRD**: notes/planning/oz-context-v1-prd.md
**Pre-mortem**: notes/planning/oz-context-v1-premortem.md
...
- [x] `notes/planning/oz-context-v1-premortem.md`: risk register complete
...
| S7-07 | All remaining pre-mortem items verified closed | Check every Tiger and Elephant in `notes/planning/oz-context-v1-premortem.md`. Mark resolved or create a tracked follow-up. |
